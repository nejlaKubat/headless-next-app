...
import { getContentForCustomerPost, getSlugsForCostumerPosts } from '@/content/queries'
import { documentToReactComponents } from '@contentful/rich-text-react-renderer'

export const generateStatcParams = async () => {
  const data = await getSlugsForCostumerPosts()
            ...
            <div className="md:grow pb-12 md:pb-20">
              <div className="max-w-3xl">
                ...
                <article className="pb-12 mb-12 border-b [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
                  ...
                  <header>
                    <h1 className="h2 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">{content.title}</h1>
